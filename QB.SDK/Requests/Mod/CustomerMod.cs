...
public class CustomerMod : QBRequest
{
    ...
    public List<Contact>? ContactsMod { get; set; }
    ...
    public List<AdditionalNote>? AdditionalNotesMod { get; set; }
    ...
    {
        var rq = new XElement(nameof(CustomerMod))
            .Append(ListID)
            .Append(EditSequence)
            .Append(Name)
            .Append(IsActive)
